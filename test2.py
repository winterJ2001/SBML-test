...
from SBMLDiagrams.visualizeSBML import _plot, animate
from SBMLDiagrams.autoLayoutSBML import *
...
v_info = _plot(sbmlStr, drawArrow=False, setImageSize=[1000,1000])
r.getReactionRates()
reaction_rates = r.simulate(0,3,5,selections = r.getReactionIds())

new_v_info = autolayout(sbmlStr, v_info, drawArrow = False, layout="spectral", output_filename = "spectral-test")
animate(v_info, m, r, reaction_rates, 5)

# autolayout(sbmlStr, edges, name_to_id, layout="spring", output_filename = "spring")
# autolayout(sbmlStr, edges, name_to_id, layout="random", output_filename = "random")
# autolayout(sbmlStr, edges, name_to_id, layout="circular", output_filename = "circular")
